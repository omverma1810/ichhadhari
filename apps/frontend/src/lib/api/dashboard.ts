...
export const dashboardAPI = {
  ...
  getCharts: <T extends DashboardChartType>(
    ...
    apiClient.get<DashboardChartResponseMap[T]>(`/dashboard/charts/${type}/`, {
      params,
    }),
  ...
  getMilkCollectionChart: (params?: {
    ...
    apiClient.get<MilkCollectionChart>("/dashboard/charts/milk-collection/", {
      params,
    }),
  ...
  getProductionChart: (params?: {
    ...
    apiClient.get<ProductionChart>("/dashboard/charts/production/", {
      params,
    }),
  ...
  getInventoryChart: (params?: {
    ...
    apiClient.get<InventoryChart>("/dashboard/charts/inventory/", {
      params,
    }),
  ...
  getAttendanceChart: (params?: {
    ...
    apiClient.get<AttendanceChart>("/dashboard/charts/attendance/", {
      params,
    }),
  ...
  getFinancialChart: (params?: {
    ...
    apiClient.get<FinancialChart>("/dashboard/charts/financial/", {
      params,
    }),
  ...
  getAlertsSummary: async (): Promise<{
    ...
    return await apiClient.get("/dashboard/alerts-summary/");
  },
